...
var files = map[string]file{
	"/favicon.png": {
		...
		FileInfo: &fileInfo{
			name:    "favicon.png",
			size:    1374,
			modTime: time.Unix(1634885965, 0),
		},
	},
	"/index.html": {
		data: file1,
	...
	"/static/vendor.09ef5adde90e15dfabdc.js": {
		data: file2,
		FileInfo: &fileInfo{
			name:    "vendor.09ef5adde90e15dfabdc.js",
			size:    272207,
			modTime: time.Unix(1634885965, 0),
		},
	},
	"/static/bundle.1530a7b4401b29d16604.js": {
		data: file3,
		FileInfo: &fileInfo{
			name:    "bundle.1530a7b4401b29d16604.js",
			size:    349346,
			modTime: time.Unix(1634885965, 0),
		},
	},
...
var subscribeToFeed = exports.subscribeToFeed = function subscribeToFeed(tree, client) {
	return client.on(function (data) {
		...
		if (tree.exists("feed", "data", full_name)) {
			var cursor = tree.select(["feed", "data", full_name]);
			cursor.merge(build);
		}
...
var RedirectRoot = (_dec = (0, _higherOrder.branch)(binding), _dec(_class = function (_Component) {
	...
	RedirectRoot.prototype.render = function render() {
		...
		return !loaded && syncing ? _react2["default"].createElement(_sync.Message, null) : !loaded ? undefined : !user ? undefined : !latest ? _react2["default"].createElement(_reactRouterDom.Redirect, { to: "/account/repos" }) : !latest.number ? _react2["default"].createElement(_reactRouterDom.Redirect, { to: "/" + latest.owner + "/" + latest.name }) : _react2["default"].createElement(_reactRouterDom.Redirect, { to: "/" + latest.owner + "/" + latest.name + "/" + latest.number });
	};
...
var repoTitle = function repoTitle(_ref) {
	...
	return _react2["default"].createElement(_reactTitleComponent2["default"], { render: match.params.owner.replace("--", " / ") + "/" + match.params.repo + " | drone" });
};
...
var renderItem = function renderItem(item) {
	return _react2["default"].createElement(
		_reactRouterDom.Link,
		{ to: "/" + item.owner + "/" + item.name, key: item.full_name },
...
var Main = (_dec = (0, _higherOrder.branch)(binding), (0, _inject.inject)(_class = _dec(_class = function (_Component) {
	...
	Main.prototype.render = function render() {
		...
		function renderBuild(build) {
			return _react2["default"].createElement(
				_reactRouterDom.Link,
				{ to: "/" + repo.owner + "/" + repo.name + "/" + build.number, key: build.number },
...
var UserRepos = (_dec = (0, _higherOrder.branch)(binding), (0, _inject.inject)(_class = _dec(_class = function (_Component) {
	...
	UserRepos.prototype.handleToggle = function handleToggle(repo, e) {
		...
		if (e.target.checked) {
			dispatch(_repository.enableRepository, drone, owner, repo.name);
		} else {
			dispatch(_repository.disableRepository, drone, owner, repo.name);
		}
	};
					...
					_react2["default"].createElement(
						...
						build.procs.map(function (child) {
							return _react2["default"].createElement(
								_reactRouterDom.Link,
								{
									to: "/" + repo.owner + "/" + repo.name + "/" + build.number + "/" + child.children[0].pid,
									key: repo.owner + "/" + repo.name + "-" + build.number + "-" + child.children[0].pid
								},
